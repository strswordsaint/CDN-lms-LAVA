...
<div>
        ...
        <div class="bg-white shadow-md rounded-lg border border-neutral-200">
            <div class="divide-y divide-neutral-200">
                <?php if (empty($assignments_upcoming)): ?>
                    <p class="text-neutral-500 p-6 text-center">No upcoming assignments.</p>
                <?php else: ?>
    ...
    <div id="tab-panel-completed" class="tab-panel">
        <div class="bg-white shadow-md rounded-lg border border-neutral-200">
            <div class="divide-y divide-neutral-200">
                <p class="text-xs text-neutral-500 p-4 bg-neutral-50">This list shows all assignments that are past due.</p>
                <?php if (empty($assignments_completed)): ?>
                    <p class="text-neutral-500 p-6 text-center">No assignments are completed.</p>
                <?php else: ?>
...
$(document).ready(function() {
    var storageKey = 'teacherActiveTab'; // Unique key for teacher assignment page
