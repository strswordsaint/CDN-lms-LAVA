...
<div class="flex justify-between items-center mb-4">
    <h1 class="text-2xl font-bold text-neutral-900"><?php echo $page_title ?? 'My Activities'; ?></h1>
</div>
...
<div>
        ...
        <div class="card overflow-hidden">
            <div class="divide-y divide-neutral-200">
                <?php if (empty($activities_upcoming)): ?>
                    <p class="text-neutral-500 p-6 text-center">No upcoming activities. You're all caught up!</p>
                <?php else: ?>
                    <?php foreach ($activities_upcoming as $assignment): // Use 'assignment' to match include ?>
    ...
    <div id="tab-panel-past-due" class="tab-panel">
        <div class="card overflow-hidden">
            <div class="divide-y divide-neutral-200">
                <p class="text-xs text-neutral-500 p-4 bg-neutral-50">This list shows activities that are past their due date and have not been submitted.</p>
    ...
    <div id="tab-panel-completed" class="tab-panel">
        <div class="card overflow-hidden">
            <div class="divide-y divide-neutral-200">
                 <p class="text-xs text-neutral-500 p-4 bg-neutral-50">This list shows all your graded or submitted activities that are past due.</p>
                <?php if (empty($activities_completed)): ?>
                    <p class="text-neutral-500 p-6 text-center">No activities have been completed yet.</p>
                <?php else: ?>
...
$(document).ready(function() {
    var storageKey = 'studentActivityTab'; // A new unique key
