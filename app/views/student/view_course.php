...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <a href="<?php echo site_url('/courses/my'); ?>" class="text-sm text-blue-600 hover:underline mb-4 inline-block">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200 mb-6">
        ...
        <div class="divide-y divide-gray-200">
            <?php if (empty($materials)): ?>
                <p class="text-gray-500 p-6 text-center">No materials have been uploaded for this course yet.</p>
            <?php else: ?>
                <?php foreach ($materials as $material): ?>
                    <div class="p-4 flex justify-between items-center hover:bg-gray-50">
                        <div class="flex items-center">
                            <i class="fas fa-file-alt text-gray-500 mr-3"></i>
                            <span class="text-sm font-medium text-gray-800"><?php echo htmlspecialchars($material['file_name']); ?></span>
                        </div>
                        <a href="<?php echo base_url() . $material['file_path']; ?>" download class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-3 rounded-md shadow-sm text-sm transition duration-200">
                        ...
                        <div class="flex flex-wrap justify-between items-center gap-4">
                            ...
                            <div class="flex-shrink-0 flex items-center gap-3">
                                <?php if (!empty($assignment['attachment_path'])): ?>
                                    <a href="<?php echo base_url() . $assignment['attachment_path']; ?>" download class="text-sm font-medium text-blue-600 hover:text-blue-800" title="Download attached file">
                                        <i class="fas fa-paperclip mr-1"></i> Download Attachment
                                    </a>
                                <?php endif; ?>
                                <a href="<?php echo site_url('/assignment/' . $assignment['assignment_id']); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md shadow text-sm transition duration-200">
